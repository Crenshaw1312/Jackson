...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        for (let rank of result.rankings) {
            ranks += rank.type.toLowerCase() + ": " + rank.rank + "\n";
        }
        ...
        .addFields(
            {name: "_ _", value: `[Trailer](${result.trailer}) | [Banner Image](${result.bannerImage}) | [Twitter: ${result.hashtag}](https://twitter.com/hashtag/${result.hashtag.slice(1)})`, inline: false},
